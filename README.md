...
- [手动搭建自动微分器](./micro-grad/)
- [BatchNorm 和 LayerNorm 原理](./batchnorm&layernorm/)
- [手动搭建神经网络](./mlp/)
- [解释 Attention 机制](./attention/)
- [Decode-only Transformer](./decode-transformer/)
- [分词器](./tokenizer/)
- [GPT-2 单卡 Demo](./gpt2-single/)
- [GPT-2 多卡 Demo](./gpt2-distro/)
...
如需运行某个子项目，请进入对应目录并查看其 README 或脚本说明。
